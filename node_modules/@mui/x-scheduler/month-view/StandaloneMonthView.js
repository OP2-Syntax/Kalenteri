...
const _excluded = ["localeText", "slots", "slotProps"];
/**
 * A Month View that can be used outside of the Event Calendar.
 */
const StandaloneMonthView = exports.StandaloneMonthView = /*#__PURE__*/React.forwardRef(function StandaloneMonthView(inProps, forwardedRef) {
  ...
  const {
    ...
    other = (0, _objectWithoutPropertiesLoose2.default)(forwardedProps, _excluded);
