...
const StandaloneAgendaView = /*#__PURE__*/React.forwardRef(function StandaloneAgendaView(inProps, forwardedRef) {
  ...
  const {
    ...
    other = _objectWithoutPropertiesLoose(forwardedProps, _excluded);
