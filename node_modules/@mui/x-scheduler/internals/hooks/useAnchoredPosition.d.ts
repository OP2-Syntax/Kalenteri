...
import type { Position } from "../utils/dialog-utils.js";
/** Positions a popup next to an anchor and keeps it in sync on resize/anchor changes. */
export declare function useAnchoredPosition(parameters: useAnchoredPosition.Parameters): void;
export declare namespace useAnchoredPosition {
