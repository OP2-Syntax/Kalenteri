...
import type { EventContextMenuContextValue, EventContextMenuProviderProps, EventContextMenuTriggerProps } from "./EventContextMenu.types.js";
export declare const EventContextMenuContext: React.Context<EventContextMenuContextValue | undefined>;
/**
 ...
 */
export declare function useEventContextMenuContext(): EventContextMenuContextValue | undefined;
export declare function EventContextMenuProvider(props: EventContextMenuProviderProps): React.JSX.Element;
/**
 ...
 */
export declare function EventContextMenuTrigger(props: EventContextMenuTriggerProps): React.ReactElement<any, string | React.JSXElementConstructor<any>>;