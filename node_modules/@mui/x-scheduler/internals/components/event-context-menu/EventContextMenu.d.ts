...
import type { EventContextMenuProps } from "./EventContextMenu.types.js";
/**
 ...
 */
export declare function EventContextMenu(props: EventContextMenuProps): React.JSX.Element;