...
import type { EditingSurface } from "./editingModePolicy.mjs";
export interface EventEditingContextValue {
   ...
   */
  startEditing: (anchorRef: React.RefObject<HTMLElement | null>, occurrence: SchedulerRenderableEventOccurrence, event?: Event, stableAnchor?: HTMLElement | null) => boolean;
  /**
