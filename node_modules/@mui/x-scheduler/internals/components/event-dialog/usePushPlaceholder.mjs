...
import { computeRange } from "./utils.mjs";
...
export function usePushPlaceholder() {
  ...
  return function pushPlaceholder(values, changedKeys) {
    ...
    const {
      ...
      surfaceType
    } = computeRange(adapter, values, displayTimezone);
