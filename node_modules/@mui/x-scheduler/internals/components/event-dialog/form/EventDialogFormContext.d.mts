...
export declare const EventDialogFormContext: React.Context<EventDialogFormStore<EventDialogFormValues> | null>;
export declare function useEventDialogFormContext(): EventDialogFormStore;
...
export declare function EventDialogFormProvider(props: EventDialogFormProviderProps): React.JSX.Element;