...
import { useEventEditingContext } from "../event-editing/index.mjs";
import { EventContextMenuTrigger } from "../event-context-menu/index.mjs";
  ...
  return /*#__PURE__*/_jsx(DayTimeGridAllDayEventsCell, {
    ...
    children: /*#__PURE__*/_jsxs(DayTimeGridAllDayEventsCellEvents, {
      ...
      children: [isLoading && /*#__PURE__*/_jsx(EventSkeleton, {
        ...
        return /*#__PURE__*/_jsx(EventContextMenuTrigger, {
          occurrence: occurrence,
