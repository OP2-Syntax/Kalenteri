...
import { schedulerOccurrencePlaceholderSelectors, schedulerOtherSelectors } from '@mui/x-scheduler-internals/scheduler-selectors';
...
const TimeGridEventTitle = styled(Typography, {
  ...
  '&[data-stacked]': _extends({}, titleLineClampSteps(true), titleLineClampSteps(false, ` and (max-width: ${NARROW_MAX_WIDTH_PX}px)`)),
  // Touch shows the title only, so it always wraps into the full height (overriding the steps above).
  [TOUCH_MEDIA]: _extends({}, titleLineClampSteps(false), {
...
const TimeGridEventTime = styled('time', {
  ...
  '&[data-variant="block"]': _extends({}, linesClampStyles(1), {
    [`@container (max-width: ${NARROW_MAX_WIDTH_PX}px)`]: {
      display: 'none'
    }
  }),
...
const TimeGridEventResizeHandler = styled(CalendarGrid.TimeEventResizeHandler, {
  ...
  [TOUCH_MEDIA]: _extends({}, getTouchResizeHandleStyles(), {
    display: 'none',
    '[data-armed] > &': {
      display: 'block'
    }
...
const TimeGridEventContent = /*#__PURE__*/React.memo(function TimeGridEventContent(props) {
  ...
  return /*#__PURE__*/_jsxs(React.Fragment, {
    children: [isStacked ? /*#__PURE__*/_jsxs(React.Fragment, {
      children: [/*#__PURE__*/_jsx(TimeGridEventTitle, {
        className: classes.timeGridEventTitle,
        "data-stacked": true,
        children: occurrence.title
      }), /*#__PURE__*/_jsxs(TimeGridEventTime, {
    ...
    }) : /*#__PURE__*/_jsxs(TimeGridEventTitle, {
      className: classes.timeGridEventTitle,
      children: [occurrence.title, ' ', /*#__PURE__*/_jsx(TimeGridEventTime, {
        className: classes.timeGridEventTime,
        "data-variant": "inline",
        children: formatTime(occurrence.displayTimezone.start.value)
      })]
    }), isRecurring && /*#__PURE__*/_jsx(TimeGridEventRecurringIcon, {
...
const TimeGridEventPlaceholder = /*#__PURE__*/React.forwardRef(function TimeGridEventPlaceholder(props, forwardedRef) {
  ...
  return /*#__PURE__*/_jsxs(TimeGridEventPlaceholderRoot, _extends({
    isDraggable: false,
    ...
    children: [placeholderHasResizeHandles && /*#__PURE__*/_jsx(TimeGridEventResizeHandler, {
      className: classes.timeGridEventResizeHandler,
      side: "start"
    }), /*#__PURE__*/_jsx(TimeGridEventContent, {
      occurrence: occurrence,
      isStacked: isStacked,
      isRecurring: isRecurring,
      classes: classes
    }), placeholderHasResizeHandles && /*#__PURE__*/_jsx(TimeGridEventResizeHandler, {
      className: classes.timeGridEventResizeHandler,
      side: "end"
    })]
  }));
...
const TimeGridEventRegular = /*#__PURE__*/React.forwardRef(function TimeGridEventRegular(props, forwardedRef) {
  ...
  const isStacked = !isLessThan30Minutes && !isBetween30and60Minutes;
  return /*#__PURE__*/_jsxs(TimeGridEventRoot, _extends({
    ...
    children: [isStartResizable && /*#__PURE__*/_jsx(TimeGridEventResizeHandler, {
      className: classes.timeGridEventResizeHandler,
      side: "start"
    }), /*#__PURE__*/_jsx(TimeGridEventContent, {
      occurrence: occurrence,
      ...
      isRecurring: isRecurring,
      classes: classes
    }), isEndResizable && /*#__PURE__*/_jsx(TimeGridEventResizeHandler, {
      className: classes.timeGridEventResizeHandler,
      side: "end"
    })]
  }));
...
export const TimeGridEvent = /*#__PURE__*/React.forwardRef(function TimeGridEvent(props, forwardedRef) {
  const {
      variant
    } = props,
    other = _objectWithoutPropertiesLoose(props, _excluded3);
  if (variant === 'placeholder') {
    return /*#__PURE__*/_jsx(TimeGridEventPlaceholder, _extends({}, other, {
      ref: forwardedRef
    }));
  }
  return /*#__PURE__*/_jsx(TimeGridEventRegular, _extends({}, other, {
    ref: forwardedRef
  }));
});
