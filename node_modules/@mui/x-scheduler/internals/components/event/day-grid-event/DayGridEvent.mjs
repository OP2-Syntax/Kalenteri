...
import { ARROW_DEPTH, LEFT_ARROW_CLIP, RIGHT_ARROW_CLIP, BOTH_ARROWS_CLIP, getArrowFocusVisibleStyles } from "../arrowClips.mjs";
...
const DayGridEventRoot = styled(CalendarGrid.DayEvent, {
  ...
  }, getArrowFocusVisibleStyles(theme.shape.borderRadius * 0.75)),
