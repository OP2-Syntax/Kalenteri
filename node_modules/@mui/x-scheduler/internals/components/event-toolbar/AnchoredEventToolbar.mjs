...
import { EventToolbar } from "./EventToolbar.mjs";
...
import { useBlockScrollWhileArmed, useDisarmOnOutsidePointer } from "../armed-occurrence/index.mjs";
 ...
 */
export function AnchoredEventToolbar(props) {
  const {
    anchor,
    occurrence
  } = props;
  ...
  return /*#__PURE__*/ReactDOM.createPortal(/*#__PURE__*/_jsx(AnchoredEventToolbarRoot, {
    ref: nodeRef,
