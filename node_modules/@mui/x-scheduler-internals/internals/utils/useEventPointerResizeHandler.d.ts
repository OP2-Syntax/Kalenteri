...
import type { EventSurfaceType, SchedulerEvent, SchedulerEventId, SchedulerEventOccurrence, SchedulerEventSide, SchedulerResourceId, TemporalSupportedObject } from "../../models/index.js";
/**
 ...
 */
export declare function useEventPointerResizeHandler(parameters: useEventPointerResizeHandler.Parameters): void;
export declare namespace useEventPointerResizeHandler {
  /**
