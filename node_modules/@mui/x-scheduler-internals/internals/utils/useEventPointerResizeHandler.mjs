...
import { schedulerOccurrencePlaceholderSelectors } from "../../scheduler-selectors/index.mjs";
import { EVENT_DRAG_PRECISION_MINUTE } from "../../constants/index.mjs";
import { applyInternalDragOrResizeOccurrencePlaceholder } from "./useDropTarget.mjs";
import { isInternalDragOrResizePlaceholder } from "./drag-utils.mjs";
import { clampResizedEventEdge } from "./resize-utils.mjs";
/**
 ...
 */
export function useEventPointerResizeHandler(parameters) {
  const {
    ref,
    side,
    enabled,
  ...
  React.useEffect(() => {
    ...
    const onPointerUp = event => {
      ...
      if (isInternalDragOrResizePlaceholder(placeholder)) {
        applyInternalDragOrResizeOccurrencePlaceholder(store, placeholder, addPropertiesToResizedEvent);
      } else {
        store.setOccurrencePlaceholder(null);
      }
    };
