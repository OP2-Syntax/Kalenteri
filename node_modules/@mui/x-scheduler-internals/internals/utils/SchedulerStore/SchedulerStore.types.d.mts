...
export interface SchedulerParameters<TEvent extends object, TResource extends object> {
   ...
   */
  onEventEditingStart?: (occurrence: SchedulerRenderableEventOccurrence, eventDetails: SchedulerEventEditingStartEventDetails) => void;
  /**
   * The timezone used to display events in the scheduler.
   *
   * Accepts any valid IANA timezone name
...
export type SchedulerEventEditingStartEventDetails = BaseUIChangeEventDetails<'edit', SchedulerEventEditingStartCustomProperties & {
  occurrence: SchedulerEventOccurrence;
}> | BaseUIChangeEventDetails<'view', SchedulerEventEditingStartCustomProperties & {
  occurrence: SchedulerEventOccurrence;
}> | BaseUIChangeEventDetails<'creation', SchedulerEventEditingStartCustomProperties & {
