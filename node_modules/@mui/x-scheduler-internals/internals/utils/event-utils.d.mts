 ...
 */
export declare function getOccurrenceKey(eventId: SchedulerEventId): string;
/**
 ...
 */
export declare function getRecurringOccurrenceKey(eventId: SchedulerEventId, day: TemporalSupportedObject, adapter: Adapter): string;
 ...
 */
export declare function getResourceSelectionMode(resource: SchedulerResourceId | SchedulerResourceId[] | null | undefined, canHaveMultipleResources: boolean, isCreating: boolean): ResourceSelectionMode;
