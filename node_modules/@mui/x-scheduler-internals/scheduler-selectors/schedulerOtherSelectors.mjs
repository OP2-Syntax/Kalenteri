...
export const schedulerOtherSelectors = {
   ...
   */
  isEditedOccurrence: (state, occurrenceKey) => {
   ...
   */
  editingOccurrence: state => state.editingOccurrence?.occurrence ?? null,
   ...
   */
  editingMode: state => state.editingOccurrence?.mode ?? null,
  /**
   ...
   */
  isEditedOccurrenceArmed: (state, occurrenceKey) => {
    const editedOccurrenceKey = state.editingOccurrence?.occurrence.key ?? null;
    return state.editingOccurrence?.mode === 'armed' && editedOccurrenceKey != null && editedOccurrenceKey === occurrenceKey;
  },
  /**
   ...
   */
  isEditedOccurrenceInEditMode: (state, occurrenceKey) => {
    const editedOccurrenceKey = state.editingOccurrence?.occurrence.key ?? null;
    return state.editingOccurrence?.mode === 'edit' && editedOccurrenceKey != null && editedOccurrenceKey === occurrenceKey;
  },
  isRecurringScopeDialogOpen: state => state.pendingRecurringEventOperation != null,
  /**
   * The default event color used when no color is specified on the event or its resource.
   */
  defaultEventColor: state => state.eventColor,
   ...
   */
  shouldEventRequireResource: state => state.shouldEventRequireResource && state.resourceIdList.length > 0,
  recurringEventsPlugin: state => state.recurringEventsPlugin,
  areRecurringEventsAvailable: state => state.recurringEventsPlugin != null,
