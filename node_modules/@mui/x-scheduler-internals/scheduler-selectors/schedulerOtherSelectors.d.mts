...
export declare const schedulerOtherSelectors: {
   ...
   */
  isEditedOccurrence: (state: State, occurrenceKey: string | undefined) => boolean;
  /**
   ...
   */
  editingOccurrence: (state: State) => import("../models/index.mjs").SchedulerEventOccurrencePlaceholder | null;
   ...
   */
  editingMode: (state: State) => import("../internals/index.mjs").SchedulerEditingMode | null;
  /**
   ...
   */
  isEditedOccurrenceArmed: (state: State, occurrenceKey: string | undefined) => boolean;
  /**
   ...
   */
  isEditedOccurrenceInEditMode: (state: State, occurrenceKey: string | undefined) => boolean;
  isRecurringScopeDialogOpen: (state: State) => boolean;
  /**
   * The default event color used when no color is specified on the event or its resource.
   */
  defaultEventColor: (state: State) => import("../models/index.mjs").SchedulerEventColor;
  displayTimezone: (state: State) => string;
  /**
   ...
   */
  shouldEventRequireResource: (state: State) => boolean;
  recurringEventsPlugin: (state: State) => import("../internals/index.mjs").SchedulerRecurringEventsPluginInterface | null;
  areRecurringEventsAvailable: (state: State) => boolean;
  isLoading: (state: State) => boolean;
  errors: (state: State) => readonly import("../internals/index.mjs").StoredError[];
};