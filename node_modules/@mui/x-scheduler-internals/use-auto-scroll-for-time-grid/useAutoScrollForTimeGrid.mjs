...
import { buildIsValidDropTarget } from "../build-is-valid-drop-target/buildIsValidDropTarget.mjs";
...
export const canAutoScrollForDrag = buildIsValidDropTarget(['CalendarGridTimeEvent', 'CalendarGridTimeEventResizeHandler', 'StandaloneEvent']);
export function useAutoScrollForTimeGrid(ref) {
  React.useEffect(() => {
