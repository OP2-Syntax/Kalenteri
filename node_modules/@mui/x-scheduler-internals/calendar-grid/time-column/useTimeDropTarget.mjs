...
import { clampResizedEventEdge } from "../../internals/utils/resize-utils.mjs";
...
export function useTimeDropTarget(parameters) {
  ...
  const getDateAtPointer = useStableCallback(input => {
    ...
    const roundedOffsetMs = Math.round(offsetMs / EVENT_DRAG_PRECISION_MS) * EVENT_DRAG_PRECISION_MS;
