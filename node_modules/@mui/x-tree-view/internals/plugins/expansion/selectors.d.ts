...
export declare const expansionSelectors: {
   ...
   */
  isItemExpanded: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId) => boolean;
  /**
   * Checks whether an item is expandable.
   */
  isItemExpandable: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId) => boolean;
};