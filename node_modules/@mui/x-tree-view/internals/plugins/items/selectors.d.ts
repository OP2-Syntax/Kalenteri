...
export declare const itemsSelectors: {
   ...
   */
  itemMeta: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId | null) => TreeViewItemMeta | null;
  /**
   * Gets the ordered children ids of an item.
   */
  itemOrderedChildrenIds: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId | null) => string[];
  /**
   * Gets the model of an item.
   */
  itemModel: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId) => any;
  /**
   * Checks whether an item is disabled.
   */
  isItemDisabled: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId) => boolean;
  /**
   * Gets the index of an item in its parent's children.
   */
  itemIndex: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId) => number;
  /**
   * Gets the id of an item's parent.
   */
  itemParentId: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId) => string | null;
  /**
   * Gets the depth of an item (items at the root level have a depth of 0).
   */
  itemDepth: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId) => number;
  /**
   * Checks whether an item can be focused.
   */
  canItemBeFocused: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId) => boolean;
  /**
