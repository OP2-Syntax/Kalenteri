...
const isItemSelectableSelector = (state, itemId) => state.itemMetaLookup[itemId]?.selectable ?? true;
const isItemSelectedSelector = (state, itemId) => selectedItemsMapSelector(state).has(itemId);
const canItemBeSelectedSelector = (state, itemId) => !state.disableSelection && !itemsSelectors.isItemDisabled(state, itemId) && isItemSelectableSelector(state, itemId);
const propagationRulesSelector = state => state.selectionPropagation;
const itemSelectionStatusSelector = (state, itemId) => {
...
export const selectionSelectors = {
   ...
   */
  selectedItemsRaw: state => state.selectedItems,
  /**
   ...
   */
  enabled: state => !state.disableSelection,
  /**
   * Checks whether multi selection is enabled.
   */
  isMultiSelectEnabled: state => state.multiSelect,
  /**
   * Checks whether checkbox selection is enabled.
   */
  isCheckboxSelectionEnabled: state => state.checkboxSelection,
  /**
   ...
   */
  isItemIndeterminate: (state, itemId) => itemSelectionStatusSelector(state, itemId) === 'indeterminate',
  /**
   ...
   */
  isFeatureEnabledForItem: (state, itemId) => !state.disableSelection && isItemSelectableSelector(state, itemId),
  /**
