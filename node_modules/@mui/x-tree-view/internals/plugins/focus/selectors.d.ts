...
export declare const focusSelectors: {
   ...
   */
  isItemTheDefaultFocusableItem: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId) => boolean;
  /**
   ...
   */
  isItemFocused: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId) => boolean;
};