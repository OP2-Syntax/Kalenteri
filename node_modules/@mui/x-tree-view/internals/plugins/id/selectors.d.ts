...
declare const treeIdSelector: (state: MinimalTreeViewState<any, any>) => string | undefined;
export declare const idSelectors: {
  /**
   * Get the id attribute of the tree view.
   */
  treeId: typeof treeIdSelector;
  /**
   ...
   */
  treeItemIdAttribute: (state: MinimalTreeViewState<any, any>, itemId: TreeViewItemId, providedIdAttribute: string | undefined) => string;
};
export {};