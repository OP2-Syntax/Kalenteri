...
const lazyLoadingSelectors = exports.lazyLoadingSelectors = {
   ...
   */
  isItemLoading: (state, itemId) => state.lazyLoadedItems?.loading[itemId ?? _items.TREE_VIEW_ROOT_PARENT_ID] != null,
  /**
   ...
   */
  itemLoadingChildrenCount: (state, itemId) => state.lazyLoadedItems?.loading[itemId ?? _items.TREE_VIEW_ROOT_PARENT_ID] ?? -1,
  /**
   * Checks whether an item has errors.
   */
  itemHasError: (state, itemId) => !!state.lazyLoadedItems?.errors[itemId ?? _items.TREE_VIEW_ROOT_PARENT_ID],
  /**
   * Get an item error.
   */
  itemError: (state, itemId) => state.lazyLoadedItems?.errors[itemId ?? _items.TREE_VIEW_ROOT_PARENT_ID]
};